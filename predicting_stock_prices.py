...
def predict_prices(dates, prices, x):
    ...
    plt.plot(dates, svr_lin.predict(dates), color='green', label='Linear Model')odel')
...
df = pd.read_csv('G:\Programs\Python\Learn Data-Science\Datasets\Apple.csv', header=None)
